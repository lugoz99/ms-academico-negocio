...
export class EvaluacionSolicitudResultadoEvaluacionController {
  ...
  async find(
    ...
    return this.evaluacionSolicitudRepository.resultadosEvaluaciones(id).find(filter);
  }
  ...
  async create(
    ...
    return this.evaluacionSolicitudRepository.resultadosEvaluaciones(id).create(resultadoEvaluacion);
  }
  ...
  async patch(
    ...
    return this.evaluacionSolicitudRepository.resultadosEvaluaciones(id).patch(resultadoEvaluacion, where);
  }
  ...
  async delete(
    ...
    return this.evaluacionSolicitudRepository.resultadosEvaluaciones(id).delete(where);
  }
}
